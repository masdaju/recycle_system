...
public class RequestWasteController {
    ...
    // 自动注入 RequestWasteService 实例，用于处理 RequestWaste 相关的业务逻辑
    @Autowired
    private RequestWasteService requestWasteService;

    // 自动注入 VWasteService 实例，用于处理 VWaste 相关的业务逻辑
    @Autowired
    private VWasteService vWasteService;

    // 自动注入 UserService 实例，用于处理用户相关的业务逻辑
    @Autowired
    private UserService userService;

    // 自动注入 WasteRequestsService 实例，用于处理废品申请相关的业务逻辑
    @Autowired
